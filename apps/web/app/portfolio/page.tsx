                ...
                <div className="space-y-2">
                  {calendar.recent_repos.slice(0, 6).map((repo) => (
                    <a
                      ...
                      className="flex items-center justify-between py-2 px-2 -mx-2 rounded-lg hover:bg-slate-800/40 transition-colors group"
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <span className="text-sm text-slate-300 group-hover:text-kiwi-400 transition-colors truncate">
                          {repo.name}
                        </span>
